                  ...
                  <div class="row">
                        <div class="col-lg-12">
                              ...
                              <table class="table table-hover">
                                    ...
                                    $jss=[];
                                    $jwb=[];
                                    ($bulan == "")?$total = mysqli_query($koneksi, "SELECT * FROM book2"):$total = mysqli_query($koneksi, "SELECT * FROM book2 WHERE (month(tanggal)=$bulan AND year(tanggal) = $tahun)");
                                    ...
                                    ($bulan == "")?$total3041 = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = '304'"):$total3041 = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = '304' AND (month(tanggal)=$bulan AND year(tanggal) = $tahun)");                                          
                                    $jmp304=[];
                                    $jpslt304=[];
                                    $jkw304=[];
                                    $jbc304=[];
                                    ...
                                    ($bulan == "")?$total304L = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = '304L'"):$total304L = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = '304L' AND (month(tanggal)=$bulan AND year(tanggal) = $tahun)");
                                    $jmp304L=[];
                                    $jpslt304L=[];
                                    $jkw304L=[];
                                    $jbc304L=[];
                                    ...
                                    ($bulan == "")?$total304304L = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = '304/304L'"):$total304304L = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = '304/304L' AND (month(tanggal)=$bulan AND year(tanggal) = $tahun)");
                                    $jmp304304L=[];
                                    $jpslt304304L=[];
                                    $jkw304304L=[];
                                    $jbc304304L=[];
                                    ...
                                    ($bulan == "")?$totalJ1 = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = 'J1'"):$totalJ1 = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = 'J1' AND (month(tanggal)=$bulan AND year(tanggal) = $tahun)");
                                    $jmpJ1=[];
                                    $jpsltJ1=[];
                                    $jkwJ1=[];
                                    $jbcJ1=[];
                                    ...
                                    ($bulan == "")?$totalJ3 = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = 'J3'"):$totalJ3 = mysqli_query($koneksi, "SELECT * FROM book2 where Grade = 'J3' AND (month(tanggal)=$bulan AND year(tanggal) = $tahun)");
                                    $jmpJ3=[];
                                    $jpsltJ3=[];
                                    $jkwJ3=[];
                                    $jbcJ3=[];
